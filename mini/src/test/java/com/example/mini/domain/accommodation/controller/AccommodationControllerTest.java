...
//import com.example.mini.domain.accommodation.model.response.AccommodationResponseDto;
...
//        List<AccommodationCardResponseDto> content = List.of(
//                AccommodationCardResponseDto.builder()
//                        .id(1L)
//                        .name("숙소 이름 1")
//                        .address("숙소 1 주소")
//                        .checkIn(LocalDateTime.now())
//                        .checkOut(LocalDateTime.now())
//                        .category(AccommodationCategory.SEOUL.getName())
//                        .build(),
//                AccommodationCardResponseDto.builder()
//                        .id(2L)
//                        .name("숙소 이름 2")
...
//        );
//
//        PagedResponse<AccommodationCardResponseDto> response = PagedResponse.<AccommodationCardResponseDto>builder()
//                .content(content)
//                .totalElements(2L)
//                .totalPages(1)
//                .build();
...
//                        .checkIn(LocalDateTime.now())
//                        .checkOut(LocalDateTime.now())
//                        .category(AccommodationCategory.JEJU.getName())
//                        .build(),
//                AccommodationCardResponseDto.builder()
//                        .id(2L)
//                        .name("애월 호텔")
...
//        AccommodationResponseDto accommodation = AccommodationResponseDto.builder()
//                .id(1L)
//                .name("제주도 펜션")
//                .address("숙소 주소 정보입니다.")
...
//        Double avgStar = 5.0;
//
//        AccommodationDetailsResponseDto response = AccommodationDetailsResponseDto.builder()
...
//                .andExpect(status().isOk())
//                .andExpect(jsonPath("$.body.accommodation.name").value("제주도 펜션"));
//
